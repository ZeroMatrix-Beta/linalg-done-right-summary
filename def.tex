...
{\bfseries\scshape}{\underline{\relscale{1.5}#1 {\footnotesize (Chapter \thechapter)}}}{0em}{\large}

\titleformat{\section}{\relscale{1.4}\bfseries\scshape}{}{0em}{\underline{#1 {\footnotesize(Section  \thesection)}}}[]

\titleformat{name=\section,numberless}
[runin] % shape
{\relscale{1.3}\bfseries\scshape} % format
{} % label
{0em} % sep
{} % before-code
[\underline{#1 \thesection}] % after-code

\titleformat{\subsection}{\relscale{1.3}\bfseries\scshape}{}{0em}{\underline{#1 {\footnotesize (Sub-Section \thesubsection)}}} %large
