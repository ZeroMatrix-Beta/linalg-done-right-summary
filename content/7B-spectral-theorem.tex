...
\begin{prf}
  ...
  implies that all entries in the first row of the matrix $\mmatrix(T)$, except possibly the first entry $a_{1,1}$, equal $0$.

  Now, \eqref{eq: mmatrix T, e1...en} implies that
  \[
  \norm{Te_2}^2 = |a_{2,1}|^2 + |a_{2,2}|^2 = |a_{2,2}|^2 \quad \text{and}
  \]
  \[
