...
\end{thm}
\begin{prf}
  We will prove $(a) \Rightarrow (b) \Rightarrow (c) \Rightarrow (d) \Rightarrow (e) \Rightarrow (f) \Rightarrow (a)$
  ...
  \StepThree Now suppose (c) holds. Then there is a orthonormal basis $e_1, \ddd, e_n$ of $V$ such that
