...
\begin{prf}
  ...
  \[
  \begin{aligned}
    &\dim (\underbrace{V_1 \times \cdots \times V_m}_{\text{domain}})=\underbrace{\dim \mynull \Gamma \vphantom{V_m}}_{= \; 0} +  \dim(\underbrace{V_1 + \cdots + V_m}_{\text{codomain} \; \subseteq \; V
    }) \\
