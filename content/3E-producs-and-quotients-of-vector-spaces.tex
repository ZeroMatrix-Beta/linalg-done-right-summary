...
\begin{prf}
  ...
  The list of all such vector is linearly independent and spans $V_1 \times \cdots \times V_m$. Thus it is a basis of $V_1 \times \cdots \times V_m$ and the length of this basis is $(\dim V_1 + \cdots + \dim V_m)$.
\end{prf}
