...
\begin{xrcs}
  ...
  \begin{xsol}
    ...
    \begin{equation}
      ...
      \psi_0(v_2) &= 25\psi_0(x^0)-10\psi_0(x^1)+\psi_0(x^2)= 0. \implies \psi_0(x^2) = 25 \;.\\
    ...
    \begin{equation}
      ...
      \psi_1(v_2) &= 25\psi_0(x^0)-10\psi_1(x^1)+\psi_1(x^2)= 0. \implies \psi_1(x^2) = 10 \;.\\
