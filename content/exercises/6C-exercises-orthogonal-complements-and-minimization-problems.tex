...
\exercise{4}
\begin{xrcs}
  Suppose $U$ and $W$ are subspaces of a finite-dimensional inner product space $V$. Prove that
  \begin{equation}
    (U + W)^\perp = U^\perp \cap W^\perp \quad \text{and} \quad (U \cap W)^\perp = U^\perp + W^\perp.
  \end{equation}

% \begin{xprf}
%   \StepOne We first show $(U + W)^\perp = U^\perp \cap W^\perp$.
%   Let $v \in V$. Then:
%   \[
%   \begin{aligned}
%     v \in (U + W)^\perp &\iff \langle v, u+w \rangle = 0 \quad \forall u \in U, w \in W \\
%     &\iff \langle v, u \rangle = 0 \;\forall u \in U \text{ and } \langle v, w \rangle = 0 \;\forall w \in W \\
%     &\iff v \in U^\perp \text{ and } v \in W^\perp \\
%     &\iff v \in U^\perp \cap W^\perp.
%   \end{aligned}
%   \]
%   Thus $(U + W)^\perp = U^\perp \cap W^\perp$.
%
%   \StepTwo We now show $(U \cap W)^\perp = U^\perp + W^\perp$.
%   Replacing $U$ and $W$ by $U^\perp$ and $W^\perp$ in Step 1 yields:
%   \[
%     (U^\perp + W^\perp)^\perp = (U^\perp)^\perp \cap (W^\perp)^\perp.
%   \]
%   Since $(S^\perp)^\perp = S$ for every subspace of a finite-dimensional inner product space (Exercise 6), this becomes:
%   \[
%     (U^\perp + W^\perp)^\perp = U \cap W.
%   \]
%   Taking orthogonal complements of both sides yields:
%   \[
%     U^\perp + W^\perp = ((U^\perp + W^\perp)^\perp)^\perp = (U \cap W)^\perp.
%   \]
% \end{xprf}
\end{xrcs}
