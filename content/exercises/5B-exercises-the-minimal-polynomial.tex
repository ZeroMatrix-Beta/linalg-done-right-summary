...
% ==============================================================================
% ORIGINAL ATTEMPT (Commented out): Exercise 1 ($\Rightarrow$ Direction Draft)
% ------------------------------------------------------------------------------
% AI FEEDBACK:
% 1. False Assumption: The draft assumes that an eigenvector $v$ of $T^2$ is also an
%    eigenvector of $T$. In general, an eigenvector of $T^2$ might not be an eigenvector
%    of $T$ (e.g. $v = v_3 + v_{-3}$ where $Tv_3 = 3v_3$ and $Tv_{-3} = -3v_{-3}$ gives
%    $T^2v = 9v$, but $Tv = 3v_3 - 3v_{-3} \neq \alpha v$).
% 2. Correct Strategy: The active proof above factors $(T^2 - 9I)v = (T-3I)(T+3I)v = 0$
%    and sets $w = (T+3I)v$. If $w \neq 0$, then $Tw = 3w$; if $w = 0$, then $Tv = -3v$.
% ==============================================================================
%    \Rightarrowdirection Let $v \in V$ be an eigenvector of $T^2$ corresponding to $\lambda = 9$.
%    Thus, $T^2 v = \lambda v$ or equivalently, $T(Tv) = \lambda v$.
%    Assume $v$ is also an eigenvector of $T$, so $Tv = \alpha v$. Therefore:
%    \begin{align}
%      T(Tv) &= \lambda v \\
%      T(\alpha v) &= \lambda v \\
%      \alpha T v &= \lambda v \\
