...
\begin{prf}
  ...
  Therefore, $\myrange T$ is closed under scalar multiplication. By \ref{thm: conditions for a subspace}, $\myrange T$ is a subspace of $W$, since we have checked for all $3$ conditions.
\end{prf}
