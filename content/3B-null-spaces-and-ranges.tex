...
\begin{prf} We want to know whether a system of linear equations has no solutions for some choice of constant terms on the right hand side. Fix positive integers $m$ and $n$, let $A_{j,k} \in \myF$ for $j = 1, \ddd, m$ and $k = 1, \ddd, n$. For $c_1, \ddd, c_m \in \myF$, consider:
  \begin{equation}
