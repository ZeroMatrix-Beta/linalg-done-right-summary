...
\subsection{Invertible Linear Maps}
  ...
  \begin{prf}
    ...
    \end{equation}
    which means $T$ is surjective ($\myrange T = \dim W$). This is because every linearly independent list of vectors of length $\dim W$ is a basis by
    \ref{thm: linearly independent list of the right length is a basis}. And that's how dimension is defined. (TODO)
    ...
    Since injectivity and surjectivity together imply invertibility, this ends the proof.
  \end{prf}
  ...
  \end{thm}
  \begin{prf}
    exercise (injectivity and surjectivity)
  \end{prf}
