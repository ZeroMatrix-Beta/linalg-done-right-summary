...
\begin{thm} [every spanning list contains a basis]
  ...
  Every spanning list $v_1, \ddd, v_n$ of a vector space $V$ can be reduced to a basis of $V$. So, if $V= \myspan {v_1, \ddd, v_n}$, then we can delete elements from that list, or leave the list unchanged, such that the list forms a basis.
\end{thm}
\begin{prf}
