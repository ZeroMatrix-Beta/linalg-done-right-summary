...
\end{thm}
\begin{prf}
  Let $B_1$ and $B_2$ be $2$ bases of $V$. Since both are linearly independent and both span $V$, we have $|B_1| \leq |B_2|$ and $|B_2| \leq |B_1|$ by using \ref{thm: length of linearly dependent list less or equal to length of spanning list}. Therefore, $|B_1|=|B_2|$.
\end{prf}
...
\end{thm}
\begin{prf}
  Since the length of every linearly independent list is smaller or equal to every spanning list in $V$ according to
  \ref{thm: length of linearly dependent list less or equal to length of spanning list}, we have the situation that the length of the basis of $U$ is less than or equal to the length of the basis of $V$.
\end{prf}


% 2.38
\begin{thm} [linearly independent list of the right length]
...
The list \eqref{eq: basis with r u and w} is contained in $V_1 + V_2$. The span of this list contains $V_1$ and $V_2$; therefore, it equals $V_1 + V_2$. Thus, to show that \eqref{eq: basis with r u and w} is a basis of $V_1 + V_2$, we only need to show that it is linearly independent. Therefore, let $a_1, \ddd, a_n, b_1, \ddd, b_j, c_1, \ddd, c_k \in \myF$, such that
\begin{equation}
