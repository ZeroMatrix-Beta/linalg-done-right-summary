...
\begin{prf}
  ...
  Thus, no elements are adjoined to $v_1, \ldots, v_n$ by such an extension process, so the list itself is already a basis of $V$.
\end{prf}
...
\begin{prf}
  ...
  But our list already has length $n$, so no elements will get deleted during the reduction process.
