...
\begin{mydef}
  ...
  Thus, $ST$ is just the usual composition  $S \circ T$ of two functions. But with linear maps, we have distributive and associative properties (see next result), so the notations seems natural.
\end{mydef}
