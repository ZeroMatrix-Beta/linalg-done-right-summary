...
\end{thm}
\begin{prf}
  Let $v \in V$. Hence $v + (-1)v = 1v + (-1)v = (1 + (-1))v = 0v = 0$ ,using the distributive property and the defintion of the multiplicative identity. This equation [$v+(-1)v=0$] tells us, that $(-1)v$ is the additive inverse of $v$, and therefore $(-1)v = -v$.
\end{prf}
